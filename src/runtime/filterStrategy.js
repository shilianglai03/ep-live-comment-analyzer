import { PRODUCT_FILTER_PROFILES } from "./productCatalog.js";

const GENERAL_PRODUCT_CONTEXT_KEYWORDS = ["多少钱", "多钱", "多少米", "几米", "啥价", "什么价", "什么价格", "价格", "价钱", "到手价", "活动价", "券后", "券后价", "优惠", "还有优惠", "券", "领券", "划算", "少点", "少一点", "能少", "能便宜", "便宜点", "下单", "链接", "第几个链接", "哪个链接", "小黄车", "发货", "今天发", "今天能发", "几天到", "快递", "顺丰", "运费", "包邮", "包邮吗", "包不包邮", "库存", "现货", "有货", "售罄", "补货", "售后", "客服", "质量", "退换", "退货", "换货", "可以退", "可以换", "能退", "能换", "能退不", "能换不", "不合适", "拍错", "咋办", "咋弄", "价保", "保修", "正品", "活动", "到手", "拍", "加购", "付款"];
